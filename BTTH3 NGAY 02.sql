...
-- Phòng chiếu số 1 điều hòa bị hỏng → chuyển trạng thái sang 'maintenance'
UPDATE rooms
SET status = 'maintenance'
WHERE id = 1;

-- Vì phòng 1 bảo trì → chuyển toàn bộ lịch chiếu ở phòng 1 sang phòng 2
UPDATE showtimes
SET room_id = 2
WHERE room_id = 1;

-- Khách hàng có số điện thoại 0987654321 hủy toàn bộ vé
DELETE FROM bookings
WHERE phone = '0987654321';

-- Rạp ngừng chiếu phim có mã là 3 → xóa hoàn toàn phim này khỏi hệ thống
DELETE FROM movies
WHERE id = 3;
